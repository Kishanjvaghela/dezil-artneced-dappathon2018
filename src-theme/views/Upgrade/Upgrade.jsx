...
import { Table, Row, Col, Card, CardBody, CardHeader, CardTitle } from 'reactstrap';
              ...
              <Col>
                <Card>
                  <CardHeader>
                    ...
                    <p className="category">Are you looking for more components? Please check our Premium Version of Now UI Dashboard React.</p>
                  </CardHeader>
                  <CardBody>
                    <Table responsive>
                      <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Documentation</td>
                          <td className="text-center"><i className="fa fa-check text-success"></i></td>
                          <td className="text-center"><i className="fa fa-check text-success"></i></td>
                        </tr>
                        <tr>
                          <td>SASS Files</td>
                        ...
                        <tr>
                          ...
                          <td className="text-center"><i className="fa fa-times text-danger"></i></td>
                          <td className="text-center"><i className="fa fa-check text-success"></i></td>
                        </tr>
                        <tr>
